...
class Login extends Component {
  ...
  render() {
    ...
    return (
      <IonPage>
        <IonContent>
          <h1 style={{ textAlign: "center", fontFamily: "sans-serif" }}><b>Eyebrows By: GR</b></h1>
          <IonItem lines="full">
          ...
          <IonRow>
            <IonCol>
              <IonButton type="submit" color="favorite" onClick={() => this.login()} expand="block">Entrar</IonButton>
            </IonCol>
          </IonRow>
        </IonContent>
      </IonPage>
