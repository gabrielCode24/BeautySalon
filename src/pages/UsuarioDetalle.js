...
class UsuarioDetalle extends Component {
    ...
    modificarUsuario = () => {
        ...
        if (telefono.length && fecha_nac.length > 0 &&
            ...
            var valuesUsuario = {
                ...
                direccion: direccion, clave: clave, perfil: perfil, activo: activo,
                ...
                <IonContent>
                    ...
                    <IonList>
                        ...
                        <IonItem>
                            ...
                            <IonInput id="nombre" style={{ "color": "gray" }} value={usuario.fec_ing} type="text" readonly></IonInput>
                        </IonItem>

                        <IonItem>
                            <IonLabel>Usuario Ingresa:</IonLabel>
                            <IonInput id="nombre" style={{ "color": "gray" }} value={usuario.usr_ing} type="text" readonly></IonInput>
                        </IonItem>

                        <IonItem>
                            <IonLabel>Fecha Actualiza:</IonLabel>
                            <IonInput id="nombre" style={{ "color": "gray" }} value={usuario.fec_act} type="text" readonly></IonInput>
                        </IonItem>

                        <IonItem>
                            <IonLabel>Usuario Actualiza:</IonLabel>
                            <IonInput id="nombre" style={{ "color": "gray" }} value={usuario.usr_act} type="text" readonly></IonInput>
                        </IonItem>
